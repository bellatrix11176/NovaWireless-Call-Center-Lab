...
def build_transcript(
    ...
    Frustration-based profanity injection is applied as a post-build pass
    based on customer patience, trust, repeat status, churn risk, and scenario.
    """
    ...
    # Post-build frustration injection
